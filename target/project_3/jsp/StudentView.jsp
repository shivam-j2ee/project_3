            ...
            <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(dto.getModifiedDatetime())%>">
					 ...
					 <div class="input-group">
                        ...
                        <input type="text" placeholder="Enter Last Name" class="form-control border" name="lastName" value="<%=DataUtility.getStringData(dto.getLastName())%>">
                           ...
                           <h6 class="paddingclass" style="color: #20B2AA " >College<font color="red">*</font></h6>
                         ...
                         <div class="input-group mb-3">
                             ...
                             <span class="input-group-text"><i style="width: 17px" class="fa fa-venus-mars"></i></span>
                           	...
                           	<%=college%>
								...
								<font color="red" class="ml-5"> <%=ServletUtility.getErrorMessage("collegeId", request) %></font>
                          
                          
                         </div>
                           
                           <h6 class="paddingclass" style="color: #20B2AA " >Date of Birth<font color="red">*</font></h6>
                           <div class="md-form">
					 ...
					 <div class="input-group">
                        ...
                        <input type="text" readonly="readonly" id="datepicker" placeholder="Enter Date of Birth" class="form-control border" name="dob" value="<%=DataUtility.getDateString(dto.getDob())%>">
                                </div>
					 ...
					 <div class="input-group">
                        ...
                        <input maxlength="10" type="text" placeholder="Enter Mobile Number" class="form-control border" name="mobileNo" value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
                                </div>
					 ...
					 <div class="input-group">
                        ...
                        <input type="text" placeholder="Enter Email" class="form-control border" name="email" value="<%=DataUtility.getStringData(dto.getEmail())%>">
                                </div>
                           ...
                           <input  class="btn btn-success btn-md" style="font-size: 17px" type="submit"  name="operation" value="<%=StudentCtl.OP_UPDATE%>">
                           <input  class="btn btn-warning btn-md" style="font-size: 17px" type="submit"  name="operation" value="<%=StudentCtl.OP_CANCEL%>">
                          
                            </div>
                          
                          <%}else{ %> 
                           <div class="text-center"  id="defaultForm-email">
                           <input  class="btn btn-success btn-md" style="font-size: 17px" type="submit"  name="operation" value="<%=StudentCtl.OP_SAVE%>">
                           <input  class="btn btn-warning btn-md" style="font-size: 17px" type="submit"  name="operation" value="<%=StudentCtl.OP_RESET%>">
